...
public class NewOtomat extends javax.swing.JFrame {
    ...
    try {
        ...
        // Girilen sayının 0'dan küçük olup olmadığını kontrol etme
        if (bakiye <= 0) {
    ...
    if (urunNo >= 1 && urunNo <= 7) {
        ...
        switch (urunNo) {
            case 1:
                ...
                JOptionPane.showMessageDialog(this, "Ürün 1 çıkarıldı.");
                break;
            case 2:
                jLabel8.setText(null);
                jLabel11.setText(null);              
                JOptionPane.showMessageDialog(this, "Ürün 2 çıkarıldı.");
                break;
            case 3:
                jLabel10.setText(null);
                jLabel12.setText(null);
                JOptionPane.showMessageDialog(this, "Ürün 3 çıkarıldı.");
                break;
            case 4:
                jLabel7.setText(null);
                jLabel13.setText(null);
                JOptionPane.showMessageDialog(this, "Ürün 4 çıkarıldı.");
                break;
            case 5:
                jLabel4.setText(null);
                jLabel14.setText(null);
                JOptionPane.showMessageDialog(this, "Ürün 5 çıkarıldı.");
                break;
            case 6:
                jLabel5.setText(null);
                jLabel16.setText(null);
                JOptionPane.showMessageDialog(this, "Ürün 6 çıkarıldı.");
                break;
            case 7:
                jLabel6.setText(null);
                jLabel15.setText(null);
                JOptionPane.showMessageDialog(this, "Ürün 7 çıkarıldı.");
                break;
            default:
                    throw new AssertionError();    
        }
